...
import csu.coderwu.csuhelp.wx.mini.annotation.support.OpenIdHandlerMethodArgumentResolver;
...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    protected void addArgumentResolvers(List<HandlerMethodArgumentResolver> argumentResolvers) {
        argumentResolvers.add(new OpenIdHandlerMethodArgumentResolver(redisTokenManager));
    }
