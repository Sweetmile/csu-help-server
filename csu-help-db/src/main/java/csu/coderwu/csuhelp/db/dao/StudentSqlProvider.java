...
import csu.coderwu.csuhelp.db.entity.StudentExample.Criteria;
import csu.coderwu.csuhelp.db.entity.StudentExample.Criterion;
...
public class StudentSqlProvider {
    ...
    public String insertSelective(Student record) {
        ...
        if (record.getEsPwd() != null) {
            sql.VALUES("es_pwd", "#{esPwd,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEsPwd() != null) {
            sql.SET("es_pwd = #{record.esPwd,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Student record) {
        ...
        if (record.getEsPwd() != null) {
            sql.SET("es_pwd = #{esPwd,jdbcType=VARCHAR}");
        }
